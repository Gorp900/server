...
local csInfo =
{
    ...
    { -- BASTOK QUESTS
        ...
        { csId = 322,   type = "quest",     log = xi.questLog.BASTOK,       requirement = xi.quest.id.bastok.THE_FIRST_MEETING              }, -- TODO: Confirm CSID for this, it's an optional CS
        ...
        { csId = 0,     type = "",          log = xi.questLog.BASTOK,       requirement = xi.quest.id.bastok.ALL_BY_MYSELF                  },
        { csId = 0,     type = "",          log = xi.questLog.BASTOK,       requirement = xi.quest.id.bastok.ACHIEVING_TRUE_POWER           },
        { csId = 473,   type = "quest",     log = xi.questLog.BASTOK,       requirement = xi.quest.id.bastok.TOO_MANY_CHEFS                 },
        { csId = 0,     type = "",          log = xi.questLog.BASTOK,       requirement = xi.quest.id.bastok.A_PROPER_BURIAL                },
        { csId = 0,     type = "",          log = xi.questLog.BASTOK,       requirement = xi.quest.id.bastok.A_PROPER_BURIAL                },
        { csId = 0,     type = "",          log = xi.questLog.BASTOK,       requirement = xi.quest.id.bastok.A_PROPER_BURIAL                },
        { csId = 0,     type = "",          log = xi.questLog.BASTOK,       requirement = xi.quest.id.bastok.A_PROPER_BURIAL                },
        { csId = 0,     type = "",          log = xi.questLog.BASTOK,       requirement = xi.quest.id.bastok.A_PROPER_BURIAL                },
    ...
    { -- OTHER QUESTS
        ...
        { csId = 0,     type = "",          log = xi.questLog.OTHER_AREAS,  requirement = xi.quest.id.otherAreas.PICTURE_PERFECT            },
        { csId = 0,     type = "",          log = xi.questLog.OTHER_AREAS,  requirement = xi.quest.id.otherAreas.PICTURE_PERFECT            },
        { csId = 0,     type = "",          log = xi.questLog.OTHER_AREAS,  requirement = xi.quest.id.otherAreas.PICTURE_PERFECT            },
        { csId = 0,     type = "",          log = xi.questLog.OTHER_AREAS,  requirement = xi.quest.id.otherAreas.PICTURE_PERFECT            },
        { csId = 434,   type = "quest",     log = xi.questLog.AHT_URHGAN,   requirement = xi.quest.id.ahtUrhgan.NO_STRINGS_ATTACHED         },
        { csId = 0,     type = "",          log = xi.questLog.AHT_URHGAN,   requirement = xi.quest.id.ahtUrhgan.PUPPETMASTER_BLUES          },
        { csId = 0,     type = "",          log = xi.questLog.AHT_URHGAN,   requirement = xi.quest.id.ahtUrhgan.PUPPETMASTER_BLUES          },
        { csId = 490,   type = "quest",     log = xi.questLog.JEUNO,        requirement = xi.quest.id.jeuno.COMEBACK_QUEEN                  },
        { csId = 0,     type = "",          log = ,                         requirement =                                                   }, -- Dancer AF pieces, part of a hiddenQuest, TODO: Implement Requirement checking for hiddenQuest? or see what requirement is best.
        { csId = 0,     type = "",          log = ,                         requirement =                                                   }, -- ^ as above. Also might need extraInfo var for writing the right piece of equipment in the CS text. see: quests/hiddenQuests/crated_dancer_artifact.lua
        ...
        { csId = 0,     type = "",          log = xi.questLog.JEUNO,        requirement = VW_OP_126_QUFIM_INCURSION                         }, -- Unimplemented? Requirement doesn't currently exist but should be this.
        { csId = 24,    type = "roe",       log = ,                         requirement =                                                   }, -- TODO: check csid, also new type of requirement, this CS is seen after tutorial RoE completed, see NPC: Isakoth.lua
        { csId = 0,     type = "",          log = ,                         requirement = TRUST_MUMOR                                       }, -- TODO: This CS is tied to the sunbreeze event 2014, how do we even track this if not check if the player has the reward?
        { csId = 594,   type = "unity",     log = ,                         requirement = UNITY_CONCORD                                     }, -- TODO: Similar to above roe type, how best to tackle this requirement?
        { csId = 598,   type = "unity",     log = ,                         requirement = UNITY_CONCORD                                     }, --  ^ as above, might need extraInfo var for showing correct UC_Leader convo
        { csId = 0,     type = "",          log = ,                         requirement = TRUST_MUMOR_II                                    }, -- TODO: This CS is tied to the sunbreeze event 2015, how do we even track this if not check if the player has the reward?
    },
    { -- ADD-ON SCENARIOS
        ...
        { csId = 30039, type = "mission",   log = xi.mission.log_id.ROV,    requirement = xi.mission.id.rov.EVER_FORWARD },
        { csId = 30040, type = "mission",   log = xi.mission.log_id.ROV,    requirement = xi.mission.id.rov.EVER_FORWARD },-- TODO: Check this csid
